...
| `RENDER_EXTERNAL_URL` | a URL pública do seu serviço, ex: `https://superodds-bot.onrender.com` (sem barra no final) |

> O Render às vezes já define `RENDER_EXTERNAL_URL` automaticamente. Se o deploy falhar reclamando dessa variável, adicione manualmente com a URL que aparece no topo da página do seu serviço no Render.
